...
const socialLinks = [
  {
    name: "LinkedIn",
    displayName: "Talk with Tunjungtirto Bot",
    subText: "on LinkedIn",
    icon: Linkedin,
  ...
  },
  {
    ...
    subText: "Desa Tunjungtirto",
    icon: Instagram,
    url: "https://www.instagram.com/desa.tunjungtirto?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "Desa Tunjungtirto",
    icon: Youtube,
    url: "https://youtube.com/@desatunjungtirto3098?si=JvQxkvcXVZKZj0xv",
    color: "#FF0000",
