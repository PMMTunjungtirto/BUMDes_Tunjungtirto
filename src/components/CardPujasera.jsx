...
const CardPujasera = ({ Img, Title, Description, Link: PujaseraLink, id }) => {
    // Handle kasus ketika PujaseraLink kosong
    const handleLiveDemo = (e) => {
        if (!PujaseraLink) {
            console.log("PujaseraLink kosong");
            e.preventDefault();
    ...
    const handleDetails = (e) => {
        if (!id) {
            ...
            e.preventDefault();
            alert("Pujasera details are not available");
        }
    };
