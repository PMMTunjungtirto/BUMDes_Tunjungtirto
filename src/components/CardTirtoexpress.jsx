...
const CardTirtoexpress = ({ Img, Title, Description, Link: TirtoexpressLink, id }) => {
    // Handle kasus ketika TirtoexpressLink kosong
    const handleLiveDemo = (e) => {
        if (!TirtoexpressLink) {
            console.log("TirtoexpressLink kosong");
            e.preventDefault();
    ...
    const handleDetails = (e) => {
        if (!id) {
            ...
            e.preventDefault();
            alert("Tirtoexpress details are not available");
        }
    };
...
export default CardTirtoexpress;